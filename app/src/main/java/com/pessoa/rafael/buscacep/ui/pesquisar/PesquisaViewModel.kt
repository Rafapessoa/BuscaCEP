package com.pessoa.rafael.buscacep.ui.pesquisar

import android.arch.lifecycle.MutableLiveData
import android.arch.lifecycle.ViewModel
import com.pessoa.rafael.buscacep.model.Endereco
import com.pessoa.rafael.buscacep.repository.EnderecoRepository
...
class PesquisaViewModel: ViewModel(){
    ...
    fun buscar(cep: String) {
       ...
       enderecoRepository.buscar(
        cep,
        onComplete = { endereco.value = it
                       mensagemErro.value = ""
                        isLoading.value = false
        },
               onError = { endereco.value = null
